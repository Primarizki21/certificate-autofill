...
> Generasi: 2026-08-11 10:10:35 | GT v9 + matcher v2 | key v1 (organizer v3+R6 + role map_jabatan) | pipeline = run v9 + router CURRENT | 0 LLM runtime call
...
- Key unik: 55 | key berulang: 3 (9 cert) | baseline LLM calls (no-KB): 29
...
|---|---|---|---|---|---|---|---|---|---|
| 1x confirm | 10 | 55 | 3 | 0 | 0 | 0 | 0 | 54/64 (84.4%) | 3/64 (4.7%) |
| 1x confirm | 20 | 55 | 3 | 0 | 0 | 0 | 0 | 44/54 (81.5%) | 3/54 (5.6%) |
| 1x confirm | 37 | 55 | 0 | 0 | 0 | 0 | 0 | 31/37 (83.8%) | 0/37 (0.0%) |
