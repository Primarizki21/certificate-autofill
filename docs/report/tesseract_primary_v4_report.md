# Laporan Evaluasi: Tesseract-Primary OCR + Composite v4.x Suite

> **Tanggal Run:** 2026-09-01 22:04:46  
...
- **All-Cells 6-Field (All-74):** MACRO exact **68.02%** (fuzzy **72.75%**).
- **Framework 5-Field (All-74):** MACRO exact **77.10%** (fuzzy **83.55%**).
